  ...
  return (
    <View className="flex-1 bg-impulse-dark justify-center px-8">
      ...
      <View className="items-center bg-impulse-gray p-8 rounded-[40px] border border-white/10">
        <Text className="text-impulse-cyan font-black text-xs uppercase tracking-[4px] mb-2">
          Pase de Acceso
        </Text>
        <Text className="text-white text-3xl font-black mb-1">
          {ticketInfo.className}
        </Text>
        <Text className="text-gray-400 font-bold mb-8">
          {ticketInfo.time} • Coach {ticketInfo.coach}
        </Text>
      ...
      <Text className="text-gray-600 text-center mt-8 px-10 text-xs">
        Presenta este código al coach al llegar al box para validar tu
        asistencia.
      </Text>
    </View>
  );
