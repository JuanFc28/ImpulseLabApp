      ...
      >
        ...
        <View style={styles.header}>
          ...
          <ThemedText style={styles.subtitle}>
            Consulta tu asistencia y clases
          </ThemedText>
        </View>
        ...
        <View style={styles.toggleContainer}>
          <TouchableOpacity
            style={[
              styles.toggleButton,
              activeTab === "Clases" && styles.toggleButtonActive,
            ]}
          ...
          >
            <ThemedText
              style={[
                styles.toggleText,
                activeTab === "Clases" && styles.toggleTextActive,
              ]}
            >
              Clases
            </ThemedText>
          ...
          <TouchableOpacity
            style={[
              styles.toggleButton,
              activeTab === "Coachs" && styles.toggleButtonActive,
            ]}
          ...
          >
            <ThemedText
              style={[
                styles.toggleText,
                activeTab === "Coachs" && styles.toggleTextActive,
              ]}
            >
              Coachs
            </ThemedText>
        ...
        <View style={styles.sectionHeader}>
          ...
          <ThemedText style={styles.sectionSubtitle}>
            Elige tu clase, profesor y horario
          </ThemedText>
        </View>
        ...
        <ThemedView style={styles.classCard}>
          <View style={styles.classInfoRow}>
            ...
            <View style={styles.classDetails}>
              ...
              <ThemedText style={styles.classTeacher}>
                Prof. Maria Gonzalez
              </ThemedText>
              <ThemedText style={styles.classSchedule}>
                Lun-Mie 9:00 AM - 10:00 AM
              </ThemedText>
            </View>
          </View>
          ...
          {!claseReservada ? (
            <TouchableOpacity
              ...
              onPress={() => setClaseReservada(true)}
            >
