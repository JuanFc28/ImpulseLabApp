...
export default function ScanAttendanceScreen() {
  ...
  if (hasPermission === false) {
    return (
      <SafeAreaView className="flex-1 bg-impulse-dark px-5 justify-center items-center">
        <IconSymbol name="camera.badge.ellipsis" size={60} color="#444" />
        <Text className="text-white text-lg font-bold mt-4 text-center">Sin acceso a la cámara</Text>
    ...
    <View className="flex-1 bg-impulse-dark">
      ...
      <View className="absolute top-12 left-5 right-5 z-10 flex-row justify-between items-center">
        ...
        <View className="bg-black/60 px-4 py-2 rounded-full border border-white/10 backdrop-blur-md">
          <Text className="text-white font-bold text-xs uppercase tracking-widest">Asistencia</Text>
        </View>
      </View>
      ...
      >
        ...
        <View className="flex-1 bg-black/40 justify-center items-center">
          ...
          <Text className="text-white font-bold mt-10 text-lg">Apunta al QR del Gimnasio</Text>
