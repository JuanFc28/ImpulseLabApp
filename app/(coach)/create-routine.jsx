                ...
                >
                    ...
                    <View className="flex-row gap-4 mb-4">
                        <View className="flex-1">
                            <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Nivel</Text>
                            <TouchableOpacity
                        ...
                        <View className="flex-1">
                            <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Duración</Text>
                            <TextInput
                                value={duration}
                    ...
                    <View className="flex-row gap-4 mb-6">
                        <View className="flex-1">
                            <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Zona Muscular</Text>
                            <TouchableOpacity
                        ...
                        <View className="flex-1">
                            <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Objetivo</Text>
                            <TouchableOpacity
                    ...
                    {exercises.length === 0 ? (
                        ...
                        exercises.map((ex, idx) => (
                            <View key={`${ex.name}-${idx}`} className="bg-[#1C1C1E] p-4 rounded-2xl border border-white/10 mb-3">
                                <View className="flex-row justify-between items-start mb-2">
                                    <View className="flex-1 pr-4">
                                        ...
                                        <View className="flex-row mt-1 gap-3">
                                            ...
                                            {!!ex.restSeconds && (
                                                <Text className="text-gray-400 font-bold text-xs">{ex.restSeconds}s Rest</Text>
                                            )}
                                        </View>
                    ...
                    <View className="bg-[#1C1C1E] w-full rounded-3xl border border-white/10 overflow-hidden max-h-[70%]">
                        ...
                        <ScrollView className="p-4" showsVerticalScrollIndicator={false}>
                            {getPickerOptions().map((opt) => (
                                <TouchableOpacity key={opt} onPress={() => selectPickerValue(opt)} className="py-4 border-b border-white/5">
                ...
                >
                    <View className="bg-[#1C1C1E] w-full rounded-t-3xl border-t border-white/10 p-6 pb-10">
                        <View className="flex-row justify-between items-center mb-6">
                            <Text className="text-white text-xl font-black">
                                {editingExerciseIndex >= 0 ? "Editar Ejercicio" : "Nuevo Ejercicio"}
                            </Text>
                        ...
                        <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Nombre del Ejercicio</Text>
                        <TextInput
                        ...
                        <View className="flex-row gap-4 mb-4">
                            <View className="flex-1">
                                <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Series</Text>
                                <TextInput
                            ...
                            <View className="flex-1">
                                <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Reps</Text>
                                <TextInput
                        ...
                        <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Descanso</Text>
                        <TextInput
                        ...
                        <Text className="text-gray-400 text-[10px] font-bold uppercase mb-2 ml-1">Notas Opcionales</Text>
                        <TextInput
                        ...
                        <TouchableOpacity onPress={saveExercise} className="bg-orange-500 py-4 rounded-2xl items-center">
                            <Text className="text-black font-black tracking-widest text-lg">
                                {editingExerciseIndex >= 0 ? "GUARDAR CAMBIOS" : "AGREGAR EJERCICIO"}
                            </Text>
                        </TouchableOpacity>
                    </View>
                </KeyboardAvoidingView>
