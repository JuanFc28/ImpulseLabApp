...
export default function ManageClassesScreen() {
  ...
  const openTimePicker = () => {
    Keyboard.dismiss();
    setTempTime(
      startTime ? new Date(`2000-01-01T${startTime}:00`) : new Date(),
    );
  ...
  const handleCreate = async () => {
    ...
    if (
      ...
      Alert.alert(
        "Campos incompletos",
        "Por favor llena todos los datos de la clase.",
      );
      return;
    }
  ...
  const handleDelete = (id, name) => {
    Alert.alert(
      "Eliminar Clase",
      `¿Estás seguro de cancelar la clase de ${name}?`,
      [
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0A0A0A" }}>
      <View className="flex-1 px-5 pt-6">
        ...
        {isLoading ? (
          ...
          <View className="flex-1 justify-center items-center">
            {/* calendar.badge.exclamationmark -> alert-circle-outline */}
          ...
          <View className="bg-[#1C1C1E] p-8 pt-6 rounded-t-[40px] border-t border-white/10 max-h-[92%]">
            ...
            >
              ...
              {isLoadingCoaches ? (
                ...
                <Text className="text-gray-400 mb-4 italic">
                ...
                <View className="mb-4">
                  {coaches.map((coach) => {
                    ...
                    return (
                      ...
                      >
                        <Text
                          className={`font-bold ${isSelected ? "text-emerald-500" : "text-white"}`}
                        >
              ...
              >
                <Text
                  className={classDate ? "text-white font-bold" : "text-[#444]"}
                >
              ...
              <View className="flex-row gap-4 mb-5">
                <View className="flex-1">
                  ...
                  >
                    <Text
                      className={
                        startTime ? "text-white font-bold" : "text-[#444]"
                      }
                    >
                      {startTime || "--:--"}
                    </Text>
