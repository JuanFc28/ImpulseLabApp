            ...
            {isLoading ? (
                ...
                >
                    {classes.map((item) => (
                        <View
                            key={item.id}
                            className="bg-impulse-gray p-5 rounded-3xl mb-4 border border-white/5 flex-row justify-between items-center"
                        >
                    ...
                    <View className="bg-impulse-gray p-8 pt-6 rounded-t-[40px] border-t border-white/10 max-h-[90%]">
                        <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                            ...
                            <TextInput
                                ...
                                className="bg-white/5 p-4 rounded-2xl text-white border border-white/5 mb-4"
                            />
                            ...
                            {isLoadingCoaches ? (
                                ...
                                <View className="bg-white/5 p-4 rounded-2xl mb-4 border border-white/5">
                                    <Text className="text-gray-400">
                                        No hay coaches registrados en Firebase.
                                    </Text>
                                </View>
                            ) : (
                                <View className="mb-4">
                            ...
                            <TouchableOpacity
                                ...
                                className="bg-white/5 p-4 rounded-2xl mb-4 border border-white/5"
                            >
                                <Text className={classDate ? "text-white" : "text-[#444]"}>
                            ...
                            {showDatePicker && (
                                <DateTimePicker
                                    value={classDate ? new Date(`${classDate}T00:00:00`) : new Date()}
                                    mode="date"
                                    display="default"
                            ...
                            <View className="flex-row gap-4 mb-8">
                                <View className="flex-1">
                                    ...
                                    <TextInput
                                        ...
                                        placeholderTextColor="#444"
                                        className="bg-white/5 p-4 rounded-2xl text-white border border-white/5"
                                    />
                                </View>
                            ...
                            <View className="flex-row gap-4 mb-6">
                                ...
                                <TouchableOpacity
                                    ...
                                    disabled={isSaving}
                                    className={`flex-1 py-4 rounded-2xl items-center justify-center shadow-lg shadow-emerald-500/20 ${
